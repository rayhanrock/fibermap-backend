# Generated by Django 5.0 on 2024-03-24 10:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_from', models.CharField(choices=[('POP', 'POP'), ('CLIENT', 'Client'), ('TJ_BOX', 'TJ BOX'), ('RESELLER', 'Reseller')], max_length=100)),
                ('end_to', models.CharField(choices=[('POP', 'POP'), ('CLIENT', 'Client'), ('TJ_BOX', 'TJ BOX'), ('RESELLER', 'Reseller')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('POP', 'POP'), ('CLIENT', 'Client'), ('TJ_BOX', 'TJ BOX'), ('RESELLER', 'Reseller')], max_length=100)),
        ...
        migrations.AddField(
            model_name='core',
            name='splitter',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='map.gpon'),
        ),
        migrations.AddField(
            model_name='core',
            name='marker',
        ...
        migrations.AddField(
            model_name='gpon',
            name='tj_box',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='map.tjbox'),
        ),
    ]
